(function () {
    function ClockCtrl($scope, $interval, $firebaseArray, $filter, WORK_TIME, BREAK_TIME, LONG_BREAK) {
    ...
    angular
        .module('timeApp')
        .controller('ClockCtrl', ClockCtrl, ['firebase']);
})();
